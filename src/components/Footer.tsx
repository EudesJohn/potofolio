      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <nav aria-label="Pied de page">
            <p className="font-mono text-xs font-semibold uppercase tracking-widest text-fog/80">
              <span className="text-benin-bright">$</span> ls ./sections
            </p>
          ...
          <div>
            <p className="font-mono text-xs font-semibold uppercase tracking-widest text-fog/80">
              <span className="text-benin-bright">$</span> cat contacts.txt
            </p>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-edge/60 pt-6 font-mono text-xs text-fog/70 sm:flex-row">
          <p>
            © {year} Eudes Johnson DJOGO — Tous droits réservés
          </p>
          <p className="inline-flex items-center gap-2 tabular-nums">
            <span className="inline-block h-1.5 w-1.5 animate-pulse rounded-full bg-benin-bright" aria-hidden />
            system online · {t('contact_location')}
          </p>
        </div>
      </div>
    </footer>
